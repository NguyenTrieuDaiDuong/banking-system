 ...
 */
@Entity
@Table(name = "account_types", uniqueConstraints = @UniqueConstraint(columnNames = "type_code"))
public class AccountTypes implements java.io.Serializable {
	...
	public AccountTypes(String typeCode, String typeName) {
		this.typeCode = typeCode;
		this.typeName = typeName;
	}

	public AccountTypes(String typeCode, String typeName, String description, BigDecimal minBalance,
	...
	@Column(name = "min_balance", precision = 15)
